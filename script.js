function dclick() {
    ...
    document.getElementById('light').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('info').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('success').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('danger').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('warning').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('secondary').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('default').style.display = "block";
    document.getElementById('default').style.border = "rgb(12, 0, 255) 1.5px solid";
}
function lclick() {
    document.querySelector('body').style.backgroundColor = "#fff";
    document.querySelector('body').style.transition = "1.7s";
    document.getElementById('light').style.border = "none";
    document.getElementById('dark').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('info').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('success').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('danger').style.border = "rgb(12, 0, 255) 1.5px solid";
    document.getElementById('warning').style.border = "rgb(12, 0, 255) 1.5px solid";
