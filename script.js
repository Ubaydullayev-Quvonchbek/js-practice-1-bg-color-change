function dclick() {
    ...
    document.getElementById('danger').style.border = "rgb(12, 0, 255) 3.5px solid";
    document.getElementById('warning').style.border = "rgb(12, 0, 255) 3.5px solid";
    document.getElementById('secondary').style.border = "rgb(12, 0, 255) 3.5px solid";
    document.getElementById('default').style.display = "block";
    document.getElementById('default').style.border = "rgb(12, 0, 255) 3.5px solid";
}
function lclick() {
